...
//System.out.println("This" + questions.get(8).getQuestion());
            ...
            //System.out.println("Here it is" + questions.get(23).getQuestion());questions.get(questions.size()-1);
       x+=22;
        return questions.get(x);
    }
    ...
    public  void addQuestion(Question ques)
    {
        questions.clear();
        dataBase();
        System.out.println("Old size" + questions.size());
        questions.add(ques);
        System.out.println("New size" + questions.size());
        System.out.println("New size" + questions.get(questions.size()-1).getGenre());
    }
